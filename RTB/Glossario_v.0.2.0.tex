...
\usepackage{tabularx, xcolor, etoolbox} % aggiungi etoolbox per condizioni% Load xcolor
...
\rhead{\textcolor[HTML]{9e978a}{ GLOSSARIO v0.2.0}
}
\cfoot{\thepage}
    ...
    \AddToShipoutPictureBG{ % Imposta il triangolo con logo
        ...
        \begin{tikzpicture}[overlay]
            ...
            \node[anchor=south east, xshift=-0.3cm, yshift=0.3cm] at (current page.south east) {
                \includegraphics[width=4.5cm]{prova.png}
            };
        \end{tikzpicture}
        \fi
    }
